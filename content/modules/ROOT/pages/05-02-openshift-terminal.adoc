...
To deploy the application, you will use the OpenShift Terminal. +
This is a web-based terminal that allows you to execute commands on the OpenShift cluster.
