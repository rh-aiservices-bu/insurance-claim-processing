...
We will start by deploying an instance of ArgoCD in your namespace. This will be used to deploy the rest of the applications.

Copy the content of the following text, and paste it in the OpenShift Terminal to deploy ArgoCD.
...
Now that Argo is deployed, if you want to connect to its UI (optional), you will need its Route. Let's find it...
